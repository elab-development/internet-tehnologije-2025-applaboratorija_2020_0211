...
class ProjectController extends Controller
{
    ...
    public function store(Request $request)
    {
        $data = $request->validate([
            ...
            'category'    => 'required|in:IT,Medicine,Biology,Physics,Chemistry,Data Science,Engineering',
    ...
    public function update(Request $request, Project $project)
    {
        ...
        $data = $request->validate([
            ...
            'category'    => 'sometimes|in:IT,Medicine,Biology,Physics,Chemistry,Data Science,Engineering',
